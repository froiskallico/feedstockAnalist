...
class NewAnalyzeView(generic.FormView):
    ...
    def form_valid(self, form):
        ...
        try:
            ...
            print(e)
            send_mail(
            subject="feedstockAnalist - Erro na análise!",
            message="""
                Oi.
...
class NewRadarItemsAnalyzeView(generic.TemplateView):
    template_name = 'feedStockAnalist/new_radar_analyze.html'
    success_url = reverse_lazy('feedStockAnalist:index')
    ...
    def get(self, request):
        ...
        try:
            ...
            send_mail(
                ...
                message="""
                    ...
                    Vim aqui só pra te avisar que a tua análise
                    para os itens do Radar de Itens Críticos foi concluída com
            ...
            message="""
                ...
                Vim aqui só pra te avisar que a tua análise
                para os itens do Radar de Itens Críticos não foi concluída com
                sucesso.
        ...
        return super(NewRadarItemsAnalyzeView, self).get(request)

    def analyze(self):
        self.synthesis = dict()
        self.synthesis["production_orders_to_analyze_list"] = "Radar"

        analyze = App()

        items_to_analyze = analyze.get_list_of_items_to_analyze(analyze_radar_items=True)
